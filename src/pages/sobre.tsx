"use client"; // necessário se houver efeitos ou estado (não obrigatório aqui, mas pode manter)

import React from "react";
import Navbar from "../components/Navbar";
import Footer from "../components/Footer";
import Head from "next/head"; // ✅ Next.js substituto do Helmet
  ...
  return (
    <div>
      <Head>
        ...
        <link rel="canonical" href="https://www.blog-f1-dashboard.com/sobre" />
        <meta
          name="description"
          content="Este projeto é uma plataforma moderna dedicada aos fãs da Fórmula 1™. Explore pilotos, equipes e estatísticas da temporada."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Sobre | F1™ Dash" />
        <meta
